...
export type CreateRabbitPayload = {
...
export type DeleteRabbitPayload = {
...
export type MenuItemObjectUnion = Category | Page | Post | Rabbit | Tag;
...
export type Mygroup = AcfFieldGroup & AcfFieldGroupFields & Mygroup_Fields & {
  __typename?: 'Mygroup';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']>;
  /** Field added to the schema as part of the &quot;Mygroup&quot; Field Group */
  myurl?: Maybe<Scalars['String']>;
};

/** Interface representing fields of the ACF &quot;Mygroup&quot; Field Group */
export type Mygroup_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** The rabbit type */
export type Rabbit = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfMygroup & {
  __typename?: 'Rabbit';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the HierarchicalContentNode type and the ContentNode type */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Fields of the Mygroup ACF Field Group */
  mygroup?: Maybe<Mygroup>;
  /** The parent of the node. The parent object can be of various types */
  parent?: Maybe<HierarchicalContentNodeToParentContentNodeConnectionEdge>;
  /** Database id of the parent node */
  parentDatabaseId?: Maybe<Scalars['Int']>;
...
/** The rabbit type */
export type RabbitAncestorsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The rabbit type */
export type RabbitChildrenArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The rabbit type */
export type RabbitContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The rabbit type */
export type RabbitEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The rabbit type */
export type RabbitEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The rabbit type */
export type RabbitTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to rabbit Nodes */
export type RabbitConnection = {
  /** A list of edges (relational context) between RootQuery and connected rabbit Nodes */
  edges: Array<RabbitConnectionEdge>;
  /** A list of connected rabbit Nodes */
  nodes: Array<Rabbit>;
  /** Information about pagination in a connection. */
  pageInfo: RabbitConnectionPageInfo;
};

/** Edge between a Node and a connected rabbit */
export type RabbitConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']>;
  /** The connected rabbit Node */
  node: Rabbit;
};

/** Page Info on the connected RabbitConnectionEdge */
export type RabbitConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
/** Connection between the Rabbit type and the rabbit type */
export type RabbitToPreviewConnectionEdge = Edge & OneToOneConnection & RabbitConnectionEdge & {
...
export type RootMutation = {
  ...
  /** The createRabbit mutation */
  createRabbit?: Maybe<CreateRabbitPayload>;
  ...
  /** The deleteRabbit mutation */
  deleteRabbit?: Maybe<DeleteRabbitPayload>;
  ...
  /** The updateRabbit mutation */
  updateRabbit?: Maybe<UpdateRabbitPayload>;
...
/** The root mutation */
export type RootMutationCreateRabbitArgs = {
...
/** The root mutation */
export type RootMutationDeleteRabbitArgs = {
...
/** The root mutation */
export type RootMutationUpdateRabbitArgs = {
...
export type RootQuery = {
  ...
  /** An object of the rabbit Type.  */
  rabbit?: Maybe<Rabbit>;
  /**
   * A rabbit object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  rabbitBy?: Maybe<Rabbit>;
  /** Connection between the RootQuery type and the rabbit type */
  rabbits?: Maybe<RootQueryToRabbitConnection>;
...
/** The root entry point into the Graph */
export type RootQueryRabbitArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<RabbitIdType>;
};


/** The root entry point into the Graph */
export type RootQueryRabbitByArgs = {
  id?: InputMaybe<Scalars['ID']>;
  rabbitId?: InputMaybe<Scalars['Int']>;
  uri?: InputMaybe<Scalars['String']>;
};


/** The root entry point into the Graph */
export type RootQueryRabbitsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToRabbitConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the rabbit type */
export type RootQueryToRabbitConnection = Connection & RabbitConnection & {
  __typename?: 'RootQueryToRabbitConnection';
  /** Edges for the RootQueryToRabbitConnection connection */
  edges: Array<RootQueryToRabbitConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Rabbit>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToRabbitConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToRabbitConnectionEdge = Edge & RabbitConnectionEdge & {
...
/** Page Info on the &quot;RootQueryToRabbitConnection&quot; */
export type RootQueryToRabbitConnectionPageInfo = PageInfo & RabbitConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToRabbitConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean'];
...
export type RootQueryToRabbitConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
export type UpdateRabbitPayload = {
...
/** Provides access to fields of the &quot;Mygroup&quot; ACF Field Group via the &quot;mygroup&quot; field */
export type WithAcfMygroup = {
  /** Fields of the Mygroup ACF Field Group */
  mygroup?: Maybe<Mygroup>;
};
